 ...
 */
var determineR1 = function determineR1(word) {
 ...
 */
var findSuffixStep1 = function findSuffixStep1(word) {
	...
	if (a1Index !== -1) {
		...
		return { index1: index1, optionUsed1: optionUsed1 };
	} else if (b1Index !== -1) {
		optionUsed1 = "b";
		index1 = b1Index;
 ...
 */
var findSuffixStep2 = function findSuffixStep2(word) {
 ...
 */
var deleteSuffix1 = function deleteSuffix1(word, index1, optionUsed1, r1Index) {
 ...
 * @returns {string} The word with the deleted suffix.
 */
var deleteSuffix2 = function deleteSuffix2(word, index2, r1Index) {
