...
var PageTitleWidthAssessment = function (_Assessment) {
	_inherits(PageTitleWidthAssessment, _Assessment);
  ...
  * @returns {void}
  */
	function PageTitleWidthAssessment() {
		var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

		_classCallCheck(this, PageTitleWidthAssessment);

		var _this = _possibleConstructorReturn(this, (PageTitleWidthAssessment.__proto__ || Object.getPrototypeOf(PageTitleWidthAssessment)).call(this));
  ...
  */
	...
	_createClass(PageTitleWidthAssessment, [{
   ...
   */
	...
	return PageTitleWidthAssessment;
